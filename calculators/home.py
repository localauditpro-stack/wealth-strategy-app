...
def render_home():
    ...
    **The Solution? Structure.** We break wealth building into 5 clear stages.
    ...
    e1, e2 = st.columns(2)
    with e1:
         st.info("**The Silent Tax Leak:** \n\nEarning $180k+? You're losing nearly half your extra income to tax. Structural changes can convert personal debt into tax-deductible debt.")
    with e2:
         st.warning("**The Cost of Laziness:** \n\nLeaving $100k in cash vs. offsetting a mortgage vs. investing in Super can mean a >$500k difference over 20 years.")
